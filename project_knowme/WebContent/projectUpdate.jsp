...
<body>
	<%
		...
		Project projectDAO = new projectDAO().getProject(projectID);
		
		if(!userID.equals(projectDAO.getUserID())) {
			PrintWriter script = response.getWriter();
			script.println("<script>");
	...
	<div id="section" style="margin-top: 70px; margin-bottom: 70px;">
		<div class="container">
			<div class="row">
				<form method="post" action="projectUpdateAction.jsp?projectID=<%=projectDAO.getProjectID()%>">
					<table class="table" style="text-align: center; border: 1px solid #dddddd">
						<thead>
							<tr>
								<th colspan="2" style="background-color: #eeeeee; text-align: center;">프로젝트 정보 수정</th>
							</tr>
						</thead>
						<tbody style="width:20%;">
							<tr>
								...
								<td>
									<input type="text" class="form-control" placeholder="프로젝트명을 입력해주세요!" name="projectName" maxlength="50" value="<%= projectDAO.getProjectName() %>">
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<textarea class="form-control" placeholder="프로젝트의 개요를 입력해주세요!" name="projectOverview" maxlength="200" style="height: 70px;"><%= projectDAO.getProjectOverview() %></textarea>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<textarea class="form-control" placeholder="특징을 입력해주세요!" name="projectSettings" maxlength="100" style="height: 70px;"><%= projectDAO.getProjectSettings() %></textarea>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<textarea class="form-control" placeholder="프로젝트의 깃헙 주소를 입력해주세요!" name="projectGithub" maxlength="100" style="height: 70px;"><%= projectDAO.getProjectGithub() %></textarea>
								</td>
							</tr>
						</tbody>
					</table>
