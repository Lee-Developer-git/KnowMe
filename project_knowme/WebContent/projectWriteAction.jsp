...
<jsp:setProperty name="project" property="projectOverview" />
...
<body>
	<%
		...
		if (userID == null) {
			...
			if (project.getProjectOverview() == null || project.getProjectGithub() == null
				...
				int result = projectDAO.write(project.getUserID(), project.getProjectOverview(),
